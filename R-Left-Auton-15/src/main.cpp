...
void autonomous() 
{
    ...
    chassis.moveToPose(0, 30.5, 180, 2000, { .forwards = false, .lead = 0.7 }, true);
    pros::delay(1); // Change So gabs while in motion
    ...
    intake.move(-127);
    chassis.moveToPose(-27.0, 29, 270, 1500, { .forwards = true, .lead=0.1 }, false);
    pros::delay(1000);

    chassis.moveToPose(-34, 46, 358, 2000, { .forwards = true, .lead=0.1 }, false);
    pros::delay(2000);

    // -- Driving Back & 4th Ring -- //

    chassis.moveToPose(-20, 30, 20, 1500, { .forwards = false, .lead=0.1 }, false);

    chassis.turnToHeading(20, 1200);

    chassis.moveToPose(20, 47, 20, 1500, { .forwards = true, .lead=0.1 }, false);


    // -- Exiting -- //
    chassis.moveToPose(20, 30, 0, 1500, { .forwards = false, .lead=0.3 }, false);
    chassis.turnToHeading(20, 1200);
