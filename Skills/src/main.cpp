...
void autonomous() 
{
    ...
    chassis.moveToPose(-25, goal_location -2, 90, 3000, {.forwards = false, .maxSpeed=100}, false);
    ...
    chassis.moveToPose(-53, goal_location - 2, 270, 2800, {.forwards = true}, false);
    ...
    chassis.moveToPose(-57, 20, 15, 2500, {.forwards = true}, false);
