...
void autonomous() 
{
    ...
    chassis.moveToPose(0, 30.5, 162, 2000, { .forwards = false }, true);
    pros::delay(1700);
    ...
    intake.move(-127);
    chassis.moveToPose(27.0, 29, 90, 1500, { .forwards = true, .lead=0.1 }, false);
    pros::delay(1000);
    ...
    chassis.moveToPose(31, 46.5, 358, 2000, { .forwards = true, .lead=0.1 }, false);
    pros::delay(1000);

    intake.move(127);

    // Drive Back
    chassis.moveToPose(20, 30, 340, 1500, { .forwards = false, .lead=0.1 }, false);

    intake.move(-127);

    chassis.turnToHeading(340, 1200);
    chassis.moveToPose(20, 47, 340, 1500, { .forwards = true, .lead=0.1 }, false);
    pros::delay(1500);
